        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6">
              ...
              <a href="#" className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1 hover:scale-105">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
